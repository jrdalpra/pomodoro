...
@ApplicationScoped
@Getter
public class BreakRunningPage implements Page {
    ...
    public void must(@Observes Break.Started started) {
        view(started.getWho());
        changePage.fire(new ChangePage(BreakRunningPage.this));
    }
