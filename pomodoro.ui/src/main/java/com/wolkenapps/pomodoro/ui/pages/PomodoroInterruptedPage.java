...
@ApplicationScoped
@Getter
public class PomodoroInterruptedPage implements Page {
    ...
    public void initUI() {
        content = new PageContentTemplate() {
            ...
            protected JPanel createTheContent() {
                ...
                JLabel jLabel = new JLabel("Pomodoro Interrupted", JLabel.CENTER);
    ...
    public void must(@Observes Pomodoro.Interrupted interrupted) {
        changePage.fire(new ChangePage(PomodoroInterruptedPage.this));
    }
