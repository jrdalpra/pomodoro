...
@ApplicationScoped
@Getter
public class BreakFinishedPage implements Page {
	...
	public void initUI() {
		content = new PageContentTemplate() {
			...
			protected JPanel createTheContent() {
				...
				innerContent.add(new JLabel("Break FINISHED", JLabel.CENTER), BorderLayout.CENTER);
				return innerContent;
			}
	...
	public void must(@Observes Break.Finished finished) {
